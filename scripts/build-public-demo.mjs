...
for(const file of ['admin-model.ts','admin-workspace.tsx','repayment.ts','repayment-settings.tsx','shared.ts','sample.ts','request.ts','organization.ts','member-enrollment.ts','loan-application.tsx','organization-editor.tsx'])copyFileSync('app/'+file,folder+'/'+file);
