...
for(const file of ['approval-queue.ts','application-queue.tsx','audit-trail.tsx','payroll.ts','payroll-excel.ts','payroll-import.tsx','collections.ts','collections-dashboard.tsx','admin-model.ts','admin-workspace.tsx','repayment.ts','repayment-settings.tsx','shared.ts','sample.ts','request.ts','organization.ts','member-enrollment.ts','loan-application.tsx','organization-editor.tsx'])copyFileSync('app/'+file,folder+'/'+file);
